...
JavaScriptCompiler.prototype = {
  ...
  appendResult: function (source) {
    let append = this.source.functionCall('container.appendResult', null, [source]);
    this.pushSource(append);
  },

  appendParseFallbackText: function (text) {
    let source = this.source.functionCall('container.appendResult', null, [this.quotedString(text), 'true']);
  ...
  //
  // Delegate a generated expression to `container.appendResult()`.
  append: function() {
